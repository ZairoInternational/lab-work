          ...
          <aside className="w-72 bg-white border-r border-gray-200 flex flex-col">
            ...
            <nav className="flex-1 p-6">
              ...
              <div className="space-y-2">
                ...
                <NavLink href="/admin/contact-info" icon={SettingsIcon}>
                  {" "}
                  Contact Info{" "}
                </NavLink>{" "}
                <NavLink href="/admin/leads" icon={LeadsIcon}>
                  {" "}
                  Leads{" "}
                </NavLink>{" "}
                <NavLink href="/admin/social-links" icon={ShareIcon}>
                  {" "}
                  Social links{" "}
                </NavLink>{" "}
                <NavLink href="/admin/certificates" icon={CertificateIcon}>
                  {" "}
                  Certificates{" "}
                </NavLink>{" "}
                <NavLink href="/admin/clients" icon={ClientsIcon}>
                  {" "}
                  Clients{" "}
                </NavLink>{" "}
                <NavLink href="/admin/reviews" icon={ReviewsIcon}>
                  {" "}
                  Voices / reviews{" "}
                </NavLink>{" "}
              </div>{" "}
